...
func (c *loginClient) DoLogin(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, "/login.Login/doLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *loginClient) LoginOut(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginRequest, error) {
	out := new(LoginRequest)
	err := c.cc.Invoke(ctx, "/login.Login/loginOut", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLoginServer) DoLogin(context.Context, *LoginRequest) (*LoginResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DoLogin not implemented")
}
func (UnimplementedLoginServer) LoginOut(context.Context, *LoginRequest) (*LoginRequest, error) {
...
func _Login_DoLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/login.Login/doLogin",
	}
...
func _Login_LoginOut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoginServer).LoginOut(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/login.Login/loginOut",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServer).LoginOut(ctx, req.(*LoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Login_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "loginOut",
			Handler:    _Login_LoginOut_Handler,
		},
	},
